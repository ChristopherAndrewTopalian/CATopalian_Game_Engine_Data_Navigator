...
function rowOfLanguage(theX, theY, sizeX, sizeY, whichArray, criteria1, criteria2)
{
    ...
    for (let i = 0; i < whichArray.length; i++)
    {
        if (whichArray[i].category == criteria1 && whichArray[i].tag == criteria2)
        {
            ...
            titleOfUrl2.textContent = "Link 2";
            ...
            titleOfLanguage.textContent = whichArray[i].language;
            ...
            titleOfCategory.textContent = whichArray[i].category;
            ...
            titleOfFunction.textContent = whichArray[i].name;
            ...
            titleOfDescription.textContent = whichArray[i].description;
            ...
            syntax.textContent = whichArray[i].syntax;
            ...
            let useage = ce("span");
            useage.textContent = whichArray[i].useage;
            ...
            returnValue.textContent = whichArray[i].type;
