...
function rowOfLanguageShowAll(theX, theY, sizeX, sizeY, whichArray, criteria1, criteria2) {
    ...
    for (let i = 0; i < whichArray.length; i++) {
        if (whichArray[i].tag == criteria1 && whichArray[i].language == criteria2)
        {
            ...
            let language = ce("span");
            language.style.fontSize = "14pt";
            language.style.lineHeight = "15pt";
            language.textContent = whichArray[i].language;
            theDiv.append(language);
            ...
            functionNameLabel.textContent = "Name of Function:";
            ...
            description.textContent = whichArray[i].description;
            ...
            let usage = ce("div");
            usage.textContent = whichArray[i].useage;
            theDiv.append(usage);
            ...
            returnType.textContent = whichArray[i].type;
