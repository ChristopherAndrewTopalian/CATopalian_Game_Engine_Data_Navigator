...
function rowOfInvestigation(theX, theY, sizeX, sizeY, whichArray, criteria1)
{
    ...
    buttonAscending.textContent = "Ascending";
    ...
    buttonDescending.textContent = "Descending";
    ...
    for (let i = 0; i < whichArray.length; i++) {
        if (whichArray[i].tag == criteria1)
        {
            ...
            if (whichArray) // shows all items
            {
                ...
                dateSpan.textContent = whichArray[i].date;
                ...
                summarySpan.textContent = whichArray[i].summary;
                ...
                noteSpan.textContent = whichArray[i].note;
                ...
                newsArticleLink.textContent = whichArray[i].newsArticleOne;
