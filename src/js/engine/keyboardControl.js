...
function theControls(e)
{
    if (controlFlag ==1)
    {
        ...
        if (e.keyCode == 88)
        {
            ...
            ge('infoDivPlayer').textContent = "Left Click for Mouse Position";
        ...
        if(e.keyCode == 192)
        {
            ...
            ge('infoDivPlayer').textContent = "Speed Tilda";
        ...
        if (e.keyCode == 49 || e.keyCode == 97)
        {
            ...
            ge('infoDivPlayer').textContent = "Speed 1";
        ...
        if (e.keyCode == 50 || e.keyCode == 98)
        {
            ...
            ge('infoDivPlayer').textContent = "Speed 2";
        ...
        if (e.keyCode == 51 || e.keyCode == 99)
        {
            ...
            ge('infoDivPlayer').textContent = "Speed 3";
        ...
        if (e.keyCode == 52 || e.keyCode == 100)
        {
            ...
            ge('infoDivPlayer').textContent = "Speed 4";
        ...
        if (e.keyCode == 53 || e.keyCode == 101)
        {
            ...
            ge('infoDivPlayer').textContent = "Speed 5";
        ...
        if (e.keyCode == 54  || e.keyCode == 102)
        {
            ...
            ge('infoDivPlayer').textContent = "Speed 6";
        ...
        if (e.keyCode == 55 || e.keyCode == 103)
        {
            ...
            ge('infoDivPlayer').textContent = "Speed 7";
        ...
        if (e.keyCode == 56 || e.keyCode == 104)
        {
            ...
            ge('infoDivPlayer').textContent = "Speed 8";
        ...
        if (e.keyCode == 57 || e.keyCode == 105)
        {
            ...
            ge('infoDivPlayer').textContent = "Speed 9";
        ...
        if (e.keyCode == 48 || e.keyCode == 96)
        {
            ...
            ge('infoDivPlayer').textContent = "Speed 0";
        ...
        if (e.keyCode == 8)
        {
            ...
            ge('infoDivPlayer').textContent = "Speed Backspace";
        ...
        if (e.keyCode == 45)
        {
            ...
            ge('infoDivPlayer').textContent = "Speed Insert";
        ...
        if (e.keyCode == 36)
        {
            ...
            ge('infoDivPlayer').textContent = "Speed Home";
        ...
        if (e.keyCode == 33)
        {
            ...
            ge('infoDivPlayer').textContent = "Speed PageUp";
        ...
        if (e.keyCode == 66)
        {
            ...
            ge('infoDivPlayer').textContent = "STRUCTURE MODE ON";
        ...
        if (e.keyCode == 27)
        {
            ...
            ge('infoDivPlayer').textContent = "STRUCTURE MODE OFF";
        ...
        if (e.keyCode == 46)
        {
            ...
            ge('infoDivPlayer').textContent = "Removed All Structures";
